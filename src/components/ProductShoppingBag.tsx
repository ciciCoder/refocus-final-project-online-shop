    ...
    <div className="flex flex-col gap-10">
      ...
      <div className="flex w-full justify-between">
        ...
        <div className="flex items-center gap-5">
          ...
          <button className="btn rounded-full bg-lavender-gray text-white hover:text-white">
            Place order
          </button>
          <div className="text-sm font-normal not-italic leading-[130%] tracking-[-0.42px] text-grape">
            To place an order,{' '}
            <button className="text-royal-blue underline">sign in</button>
          </div>
        </div>
      </div>
    </div>
